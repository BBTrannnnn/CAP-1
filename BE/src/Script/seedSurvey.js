...
const habitSuggestions = [
  ...
  {
    name: 'Tập thể dục buổi sáng 20 phút',
  ...
  {
    name: 'Hoàn thành 3 việc quan trọng nhất',
    description: 'Tập trung vào 3 ưu tiên hàng đầu',
    category: 'productivity',
    difficulty: 'medium',
    frequency: 'daily',
    estimatedTime: 180,
  ...
  {
    name: 'Xem video giáo dục 20 phút',
  ...
  {
    name: 'Nghe podcast khi di chuyển',
  ...
  {
    name: 'Ghi chép những gì học được',
  ...
  },
  {
    ...
    description: 'Dành 30 phút ra ngoài trời',
    category: 'mindful',
    difficulty: 'easy',
    frequency: 'daily',
    estimatedTime: 30,
  ...
  {
    name: 'Theo dõi chi tiêu hàng ngày',
    description: 'Ghi chép tất cả chi tiêu',
    category: 'finance',
    difficulty: 'easy',
    frequency: 'daily',
    estimatedTime: 5,
  ...
  {
    name: 'Tắt điện thoại trước khi ngủ 1 tiếng',
    description: 'Ngừng sử dụng thiết bị điện tử',
    category: 'digital',
    difficulty: 'medium',
    frequency: 'daily',
    estimatedTime: 5,
  ...
  },
  {
    ...
    description: 'Nâng cao kỹ năng công cụ mới',
    category: 'digital',
    difficulty: 'medium',
    frequency: 'weekly',
    estimatedTime: 120,
  ...
  },
  {
    ...
    description: 'Chạy bộ 20-30 phút',
    category: 'fitness',
    difficulty: 'medium',
    frequency: 'daily',
    estimatedTime: 30,
  ...
  {
    name: 'Uống trà xanh thay cà phê',
    description: 'Năng lượng bền vững hơn',
    category: 'energy',
    difficulty: 'easy',
    frequency: 'daily',
    estimatedTime: 5,
  ...
  },
  {
    ...
    description: 'Ăn trái cây hoặc hạt',
    category: 'energy',
    difficulty: 'easy',
    frequency: 'daily',
    estimatedTime: 5,
  ...
  },
  {
    ...
    description: 'Hạn chế fast food xuống 1 lần/tuần',
    category: 'control',
    difficulty: 'medium',
    frequency: 'weekly',
    estimatedTime: 10,
  ...
  },
  {
    ...
    description: 'Hạn chế xem TV dưới 1 tiếng/ngày',
    category: 'control',
    difficulty: 'hard',
    frequency: 'daily',
    estimatedTime: 60,
  ...
  {
    name: 'Giảm sử dụng điện thoại trong WC',
  ...
  },
  {
    ...
    description: 'Ngừng ăn uống trước khi ngủ 3 tiếng',
    category: 'control',
    difficulty: 'medium',
    frequency: 'daily',
    estimatedTime: 5,
